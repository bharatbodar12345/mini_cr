        ...
        <div class="col-lg-12 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Companie Add</h6>
                </div>

                <div class="card-body">

                    <form method="POST" action="{{ route('companie.store') }}" autocomplete="off" enctype="multipart/form-data" >
                        <h6 class="heading-small text-muted mb-4">Add Companie Details</h6>
@csrf
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="website">Website<span
                                            class="small text-danger">*</span></label>
                                        <input type="text" id="website" class="form-control @error('website') is-invalid @enderror" name="website"
